...
parser.add_argument('--root', default='/home/zeyi/PycharmProjects/yolo_learning/data/dataset', help='data root')
parser.add_argument('-size', '--input_size', default=416, type=int, help='输入图像尺寸')
parser.add_argument('-v', '--version', default='yolo', help='yolo')
parser.add_argument('--weight', default=None, type=str, help='模型权重的路径')
parser.add_argument('--conf_thresh', default=0.1, type=float, help='得分阈值')
parser.add_argument('--nms_thresh', default=0.50, type=float, help='NMS 阈值')
parser.add_argument('-vs', '--visual_threshold', default=0.3, type=float, help='用于可视化的阈值参数')
parser.add_argument('--cuda', action='store_true', default=False, help='use cuda.')
parser.add_argument('--save', action='store_true', default=False, help='save vis results.')
...
def test(args, model, device, testset, transform, class_colors=None, class_names=None, class_indexs=None):
    ...
    for index in range(num_images):
        ...
        img, _ = testset.pull_image(index)  # pull_image返回原始图像
        h, w, _ = img.shape
